...
function SpongebobLoginForm() {
  ...
  return (
    <main className="w-full h-[85vh] lg:h-[90vh] p-5 flex justify-center items-center">
      <div className="w-80 h-150 bg-[#fbf468] rounded-4xl px-12 py-8 flex flex-col justify-between items-center shadow-md shadow-zinc-700 *:w-full">
        <div className="flex justify-center relative">
          <img
            loading="lazy"
            className="rounded"
            src="/images/spongebob-login-form/bobno.png"
            alt="spongebob"
          />
          <img
            loading="lazy"
            id="left-eye"
            className="absolute size-8 top-17 right-12 duration-500"
            src="/images/spongebob-login-form/eye.png"
            alt="left-eye"
          />
          <img
            loading="lazy"
            id="right-eye"
            className="absolute size-8 top-17 left-12 duration-500"
            src="/images/spongebob-login-form/eye.png"
            alt="right-eye"
          />
        </div>
        <div className="flex flex-col justify-around gap-4" dir="ltr">
          <input
            ...
            className="border border-zinc-600 text-zinc-600 rounded-sm px-3 py-2"
        ...
        <div>
          <button className="w-full py-2 btn bg-blue-500 border-blue-500 hover:bg-blue-400 rounded-md text-white text-lg shadow-sm shadow-blue-700">
            Login
          </button>
        </div>
      </div>
